              ...
              <div className="main-content main-content-card overflow-auto">
                  <section className="checkout mx-auto">
                      ...
                      <div className="purchase pt-30">
                          ...
                          <DetailRow label="Price" value="Rp 42.280.500" />
                          <DetailRow label="Tax (10%)" value="Rp 4.228.000" />
                          <DetailRow label="Total" value="Rp 55.000.600" className="color-palette-4" />
                      </div>
                      <div className="payment pt-10 pb-10">
                          <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                          <DetailRow label="Your Account Name" value="Masayoshi" />
                          <DetailRow label="Type" value="Worldwide Transfer" />
                          <DetailRow label="Bank Name" value="Mandiri" />
                          <DetailRow label="Bank Account Name" value="PT Store GG" />
                          <DetailRow label="Bank Number" value="1800" />
                      </div>
